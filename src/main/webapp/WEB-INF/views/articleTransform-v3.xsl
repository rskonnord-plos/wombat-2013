...
<!--
   - Wombat note:
   - This is here as a development stopgap only!
   - Eventually the .war file should not contain any *.xsl files, but fetch them all through the service API.
  -->
                  ...
                  <xsl:element name="ul">
                    ...
                    <xsl:if test="$cit/extraCitationInfo/@crossRefUrl">
                      <xsl:element name="li">
                        <xsl:element name="a">
                          ...
                          <xsl:attribute name="onclick">window.open(this.href, 'ambraFindArticle', ''); return false;
                          </xsl:attribute>
                    ...
                    <xsl:if test="$cit/extraCitationInfo/@pubGetUrl">
                      <xsl:element name="li">
                        <xsl:element name="a">
                          <xsl:attribute name="href">
                            <xsl:value-of select="$cit/extraCitationInfo/@pubGetUrl"/>
                          </xsl:attribute>
                          <xsl:attribute name="onclick">window.open(this.href, 'ambraFindArticle', ''); return false;
                          </xsl:attribute>
